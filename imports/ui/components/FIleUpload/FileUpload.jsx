...
class FileUploadComponent extends Component {
  ...
  showUploads() {
    ...
    if (this.state.uploading && this.state.uploading.length) {
      return <div>
  ...
  render() {
    ...
    if (this.props.files && this.props.docsReadyYet) {
      ...
      return <div>
        ...
        {display}
        <hr/>
        <img src='http://localhost:3000/files/UserFiles/UserFiles/Mezdhd7f3ikufPkiA/original/Mezdhd7f3ikufPkiA.png'></img>
      </div>
    }
